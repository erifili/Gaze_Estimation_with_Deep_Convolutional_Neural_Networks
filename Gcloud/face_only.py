...
def readData(filename, flag):
    ...
    if flag == 'Training':
        ...
        train_data = [train_face, train_labels]
        ...
        test_data = [test_face, test_labels]
...
def model(train_data, val_data, net_params, epochs, eta, train_data_size, val_data_size, batch_size, min_diff, patience, print_per_epoch, save_model_dir_fname):
    ...
    W = {
            ...
            'fc1': init_weights([net_params.fc_f2_size, net_params.fc1_size], name='fc1_w'),
    ...
    ## output
    fc1 = tf.nn.relu(fully_conn_layer(fc2_f, W['fc1'], b['fc1']))
    ...
    with tf.Session() as sess:
        ...
        for ep in tqdm(range(1, epochs + 1)):
            ...
            for batch in readChunks(train_data, train_data_size, batch_size):
                ...
                sess.run(optimizer, feed_dict={face: face_batch,  y: y_batch})
                                
                train_batch_loss, train_batch_error = sess.run([loss, error], feed_dict={face: face_batch,  y: y_batch})
            ...
            for batch in readChunks(val_data, val_data_size, batch_size):
                ...
                y_batch_val = batch[1]
                val_batch_loss, val_batch_error = sess.run([loss, error], feed_dict={face: face_batch_val,  y: y_batch_val})
...
def main():
    ...
    if args.tr:
        ...
        for batch in readChunks(test_data, test_data[0].shape[0], batch_size):
            ...
            y_pred = sess.run(pred, feed_dict={face_test: face_batch_test,  y: y_batch_test})
