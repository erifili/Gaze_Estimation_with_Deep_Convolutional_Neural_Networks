...
def model(train_data, val_data, net_params, epochs, eta, train_data_size, val_data_size, batch_size, min_diff, patience, print_per_epoch, save_model_dir_fname):
    ...
    W = {
            ...
            'fc_face_fg': init_weights([net_params.fc_f1_size + net_params.fc_fg1_size, net_params.fc_face_fg_size], name='fc_face_fg_w'),
            'fc1': init_weights([net_params.fc_e1_size + net_params.fc_face_fg_size, net_params.fc1_size], name='fc1_w'),
    ...
    b = {
            ...
            'fc_face_fg': init_bias([net_params.fc_face_fg_size]),
    ...
    #-------> face and face_grid
    fc_face_fg = tf.concat([fc1_f, fc1_fg], 1)
    fc2 = tf.nn.relu(fully_conn_layer(fc_face_fg, W['fc_face_fg'], b['fc_face_fg']))

    ## output
    fc = tf.concat([fc_e1, fc2], 1)
